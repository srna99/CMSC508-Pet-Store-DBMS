<html>
	...
	<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            echo "<tr><td>substrate</td><td><input name='brand' type='text' size='10'></td></tr>";
            echo "<tr><td>opening_diameter</td><td><input name='quantity' type='number' min='0 step='1' size='11'></td></tr>";
