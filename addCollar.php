<html>
	...
	<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            echo "<form method='post' action='addCollar.php'>";
            echo "<table>";
            echo "<tbody>";
            ...
            try {
                ...
                // insert into table
                $stmt = $conn->prepare("insert into Collar values (:SN, :type_of,:size,:price,:quantity,:animal);");
                ...
                echo "Successfully added new Collar.";
