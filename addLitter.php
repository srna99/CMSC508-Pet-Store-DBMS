<html>
	...
	<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            echo "<form method='post' action='addLitter.php'>";
            echo "<table>";
            echo "<tbody>";
            ...
            try {
                ...
                // insert into table
                $stmt = $conn->prepare("insert into Litter values (:SN,:brand,:price,:quantity,:animal);");
                ...
                echo "Successfully added new Litter.";
