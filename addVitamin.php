<html>
	...
	<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            echo "<form method='post' action='addVitamin.php'>";
            echo "<table>";
            echo "<tbody>";
            ...
            try {
                ...
                // insert into table
                $stmt = $conn->prepare("insert into Vitamin values (:SN,:type_of,:price,:quantity,:animal);");
                ...
                echo "Successfully added new Vitamin.";
