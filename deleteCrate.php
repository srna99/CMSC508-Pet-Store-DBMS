<html>
	...
	<body>
        ...
        if ($_SERVER['REQUEST_METHOD'] != 'POST') {
            ...
            echo "<form method='post' action='deleteCrate.php'>";
            echo "<table>";
            echo "<tbody>";
            echo "<tr><td>Select a Crate</td><td>";
            ...
            try {
                ...
                // delete from table
                $stmt = $conn->prepare("delete from Crate where SN = :SN;");
                
                $stmt->bindValue(':SN', $_POST['SN']);
                
                $stmt->execute();
                
                echo "Successfully deleted Crate.";
